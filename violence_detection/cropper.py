...
if __name__ == "__main__":
    ...
    # TODO: Change this function capture_frames() so that it captures more frames per second
    ...
    # For each frame we need to run the violence detection prediction

    # Save that in a list of probability violence
    # Transform the sequence of the probability of violence back into a video > above threshold

    # TODO: ENSURE what's the shape of the input into the RNN model for violence detection

    # Output the results onto the rectangle in the streamlit app on the video
